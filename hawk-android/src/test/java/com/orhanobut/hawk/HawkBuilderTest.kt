...
class HawkBuilderTest {
  ...
  @Test fun testLogInterceptor() {
    builder.build()
      assertThat(builder.logger).isInstanceOf(LogInterceptor::class.java)
    ...
    class MyLogInterceptor : LogInterceptor {
      ...
      builder.setLogger(MyLogInterceptor()).build()
      assertThat(builder.logger).isInstanceOf(MyLogInterceptor::class.java)
  }
}
